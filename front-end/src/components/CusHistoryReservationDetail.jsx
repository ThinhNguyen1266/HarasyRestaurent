...
const CusHistoryReservationDetail = ({ reservation, onClose }) => {
  if (!reservation) return null;

  return (
    <div className="cus-reservation-overlay" onClick={onClose}>
      <div
        className="cus-reservation-dialog cus-reservation-modal"
        ...
        <div className="cus-reservation-body">
          <div className="cus-reservation-detail">
            <div className="cus-reservation-row">
              <div className="cus-reservation-label">
                <strong>ID</strong>
              </div>
            ...
            <div className="cus-reservation-row">
              ...
              <div className="cus-reservation-value">
              ...
              <div className="cus-reservation-orders">
                <ul className="cus-reservation-order-list">
                  {reservation.orders.map((order, index) => (
                    <li key={index} className="cus-reservation-order-item">
                      {order}
                    </li>
                  ))}
                </ul>
...
export default CusHistoryReservationDetail;
